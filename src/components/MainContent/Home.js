...
const Home = () => {
  ...
  return (
    <div className="scrollbar px-4">
      {loading ? <div className="flex justify-center pt-48"><ScaleLoader color="#57b660" /></div>:  <><h1 className="mt-6 mb-4 ml-6 text-xl lg:text-2xl font-bold">早安</h1><div className="mr-6 grid gap-2 md:gap-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
      ...
      </div><h1 className="mt-8 mb-4 ml-6 text-lg lg:text-2xl font-bold">
          你的熱門合輯
        </h1><div className="px-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
          <Link to="album-viuxtemps">
        ...
        </div><h1 className="mt-6 mb-4 ml-6 text-lg lg:text-2xl font-bold">
          你最愛的音樂家
        </h1><div className="px-6 mb-10 grid grid-cols-1 gap-4 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
