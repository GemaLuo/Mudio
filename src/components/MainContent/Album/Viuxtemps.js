...
const Viuxtemps = () => {
  ...
  const albumList = songslist.slice(7, 14);
      ...
      <div className="flex-none md:flex justify-center md:justify-center lg:justify-start bg-gradient-to-b from-red-600 to-red-800/5 h-72 md:h-80">
        ...
        <div className="md:w-3/5 lg:w-3/6 xl:w-3/6 md:h-2/3 ml-6 mt-8 md:ml-8 lg:mt-6 lg:ml-12 xl:mt-4 ">
          <p className="text-lg line-clamp-2 font-semibold md:font-bold md:text-2xl md:mt-24 lg:mt-28 xl:mt-32">
            Viuxtemps: Violin Concerto No.5 in A Minor, Op.37, Bruch: Scottish
            Fantasy, Op.46
          </p>
          <p className="text-sm font-medium my-2">
            ...
            <span className="invisible md:visible">
              ・7 首歌曲，
              <span className="text-gray-300 text-sm">43 分鐘 2 秒</span>
            </span>
          </p>
